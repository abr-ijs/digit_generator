function DMP_object=st_8(postavitev,DMP,ploting)
...
xRadius1 = postavitev.w/2+rand_number()*s_rx;
yRadius1 = postavitev.h/4+rand_number()*s_ry;
xRadius2 = postavitev.w/2+rand_number()*s_rx;
yRadius2 = postavitev.h/4+rand_number()*s_ry;
